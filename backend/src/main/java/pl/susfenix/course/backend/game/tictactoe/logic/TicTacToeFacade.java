...
public class TicTacToeFacade implements TicTacToeApi {
    ...
    public TicTacToeFacade(TicTacToeGameState gameState, Player[] allPlayers, SmartComputerPlayerMover smartComputerPlayerMover, DumbComputerPlayerMover dumbComputerPlayerMover) {
